...
final class SessionModel: Model, @unchecked Sendable {
    ...
    init(id: UUID? = nil, title: String? = nil, mp4URL: String? = nil, hlsURL: String? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, publishedAt: Date? = nil, status: StatusEnum.RawValue? = nil, price: PriceEnum.RawValue? = nil, article: UUID? = nil, course: UUID? = nil, slug: String? = nil) {
        self.id = id
        self.title = title
        self.mp4URL = mp4URL
        self.hlsURL = hlsURL
